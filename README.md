...
Autora: Bohórquez Blanco Salome (1401654) 
...
Codigo para el mensaje.py	baudios	8	1 (Odd)	1
Cómo reproducir la práctica
Cargar el script MicroPython deseado en la Raspberry Pi Pico 2W (usando Thonny u otro IDE compatible).
Conectar el pin TX (GPIO0) y GND de la Pico al canal correspondiente del analizador lógico.
Configurar el software de captura con la frecuencia de muestreo deseada y añadir el decodificador Async Serial con los parámetros de la tabla anterior.
